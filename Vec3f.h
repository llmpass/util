...
inline bool operator==(Vec3f &v1, Vec3f &v2) 
...
inline Vector<float> ConjugateGradient(Sparse_Matrix<float>& A, Vector<float>
  b,Vector<float> x, int iMax=200, float eps=0.01) {
  int i = 0;
